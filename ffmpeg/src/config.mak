...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --prefix=armv6 --enable-cross-compile --enable-nonfree --cpu=armv6 --arch=arm --enable-neon --cc=/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc --as='./gas-preprocessor/gas-preprocessor.pl /Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc' --extra-cflags='-arch armv6' --extra-ldflags='-arch armv6 -isysroot/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk' --sysroot=/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk --enable-static --disable-shared --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-avfilter --disable-muxers --disable-demuxers --disable-encoders --enable-decoders --disable-pthreads --disable-parsers --disable-bsfs --disable-filters --disable-network --disable-protocols --disable-indevs --enable-decoder=h264 --enable-fft --enable-mdct --disable-debug --disable-doc --disable-postproc --disable-stripping --enable-pic
prefix=armv6
...
CPPFLAGS= --sysroot=/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS= -arch armv6 -march=armv6 -std=c99 -fomit-frame-pointer -fPIC -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -mllvm -stack-alignment=16
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS= -arch armv6 -march=armv6 -fPIC
AS_O=-o $@
CC_O=-o $@
CXX_O=-o $@
LDFLAGS= -arch armv6 -isysroot/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk --sysroot=/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS5.0.sdk -Wl,-dynamic,-search_paths_first
...
ACODEC_TESTS=aref g722 g723_1 pcm_alaw pcm_f32be pcm_f32le pcm_f64be pcm_f64le pcm_mulaw pcm_s16be pcm_s16le pcm_s24be pcm_s24daud pcm_s24le pcm_s32be pcm_s32le pcm_s8 pcm_u8 
VCODEC_TESTS=amv cljr dnxhd_720p_10bit flashsv2 jpeg2000 mpng msvideo1 prores qtrle qtrlegray v210 vref zlib zmbv 
LAVF_TESTS=caf rso sox voc_s16 wtv 
